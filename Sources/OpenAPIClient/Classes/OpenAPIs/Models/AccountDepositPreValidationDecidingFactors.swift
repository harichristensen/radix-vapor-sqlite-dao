...
public struct AccountDepositPreValidationDecidingFactors: Codable, JSONEncodable, Hashable {
    ...
    public var isBadgeAuthorizedDepositor: Bool?
    ...
    public var resourceSpecificDetails: [AccountDepositPreValidationDecidingFactorsResourceSpecificDetailsItem]?
