...
public struct TransactionStatusResponseKnownPayloadItem: Codable, JSONEncodable, Hashable {

    /** Bech32m-encoded hash. */
    public var payloadHash: String
    public var status: TransactionStatus
    public var payloadStatus: TransactionPayloadStatus?
    /** An additional description to clarify the payload status.  */
    public var payloadStatusDescription: String?
    ...
    public var handlingStatus: TransactionPayloadGatewayHandlingStatus?
    /** Additional reason for why the Gateway has its current handling status.  */
    public var handlingStatusReason: String?
