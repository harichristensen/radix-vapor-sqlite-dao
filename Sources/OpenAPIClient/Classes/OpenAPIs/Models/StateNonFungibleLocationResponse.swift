...
public struct StateNonFungibleLocationResponse: Codable, JSONEncodable, Hashable {

    public var ledgerState: LedgerState
    /** Bech32m-encoded human readable version of the address. */
    public var resourceAddress: String
    public var nonFungibleIds: [StateNonFungibleLocationResponseItem]

    public init(ledgerState: LedgerState, resourceAddress: String, nonFungibleIds: [StateNonFungibleLocationResponseItem]) {
