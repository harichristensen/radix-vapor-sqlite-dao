//
// AccountAuthorizedDepositorsNonFungibleBadgeAllOf.swift
//
...
public struct AccountAuthorizedDepositorsNonFungibleBadgeAllOf: Codable, JSONEncodable, Hashable {
    ...
    public init(resourceAddress: String, nonFungibleId: String, lastUpdatedAtStateVersion: Int64) {
