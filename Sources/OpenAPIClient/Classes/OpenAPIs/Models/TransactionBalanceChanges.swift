...
public struct TransactionBalanceChanges: Codable, JSONEncodable, Hashable {

    /** A list of all fee-related fungible balance changes per entity and resource.  */
    public var fungibleFeeBalanceChanges: [TransactionFungibleFeeBalanceChanges]
    /** A list of all non-fee-related fungible balance changes per entity and resource.  */
    public var fungibleBalanceChanges: [TransactionFungibleBalanceChanges]
    /** A list of all non-fungible changes per entity and resource.  */
    public var nonFungibleBalanceChanges: [TransactionNonFungibleBalanceChanges]
