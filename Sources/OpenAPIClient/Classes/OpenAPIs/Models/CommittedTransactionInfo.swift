...
public struct CommittedTransactionInfo: Codable, JSONEncodable, Hashable {

    public var stateVersion: Int64
    public var epoch: Int64
    public var round: Int64
    public var roundTimestamp: String
    ...
    public var feePaid: String?
    public var affectedGlobalEntities: [String]?
    ...
    public var manifestInstructions: String?
    ...
    public var manifestClasses: [ManifestClass]?
    ...
    public var balanceChanges: TransactionBalanceChanges?
