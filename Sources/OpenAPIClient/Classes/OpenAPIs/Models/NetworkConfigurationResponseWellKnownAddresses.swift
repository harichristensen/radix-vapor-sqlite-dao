...
public struct NetworkConfigurationResponseWellKnownAddresses: Codable, JSONEncodable, Hashable {

    /** Bech32m-encoded human readable version of the address. */
    public var xrd: String
    /** Bech32m-encoded human readable version of the address. */
    public var secp256k1SignatureVirtualBadge: String
    /** Bech32m-encoded human readable version of the address. */
    public var ed25519SignatureVirtualBadge: String
    /** Bech32m-encoded human readable version of the address. */
    public var packageOfDirectCallerVirtualBadge: String
    /** Bech32m-encoded human readable version of the address. */
    public var globalCallerVirtualBadge: String
    /** Bech32m-encoded human readable version of the address. */
    public var systemTransactionBadge: String
    /** Bech32m-encoded human readable version of the address. */
    public var packageOwnerBadge: String
    /** Bech32m-encoded human readable version of the address. */
    public var validatorOwnerBadge: String
    /** Bech32m-encoded human readable version of the address. */
    public var accountOwnerBadge: String
    /** Bech32m-encoded human readable version of the address. */
    public var identityOwnerBadge: String
    /** Bech32m-encoded human readable version of the address. */
    public var packagePackage: String
    /** Bech32m-encoded human readable version of the address. */
    public var resourcePackage: String
    /** Bech32m-encoded human readable version of the address. */
    public var accountPackage: String
    /** Bech32m-encoded human readable version of the address. */
    public var identityPackage: String
    /** Bech32m-encoded human readable version of the address. */
    public var consensusManagerPackage: String
    /** Bech32m-encoded human readable version of the address. */
    public var accessControllerPackage: String
    /** Bech32m-encoded human readable version of the address. */
    public var transactionProcessorPackage: String
    /** Bech32m-encoded human readable version of the address. */
    public var metadataModulePackage: String
    /** Bech32m-encoded human readable version of the address. */
    public var royaltyModulePackage: String
    /** Bech32m-encoded human readable version of the address. */
    public var accessRulesPackage: String
    /** Bech32m-encoded human readable version of the address. */
    public var roleAssignmentModulePackage: String
    /** Bech32m-encoded human readable version of the address. */
    public var genesisHelperPackage: String
    /** Bech32m-encoded human readable version of the address. */
    public var faucetPackage: String
    /** Bech32m-encoded human readable version of the address. */
    public var consensusManager: String
    /** Bech32m-encoded human readable version of the address. */
    public var genesisHelper: String
    /** Bech32m-encoded human readable version of the address. */
    public var faucet: String
    /** Bech32m-encoded human readable version of the address. */
    public var poolPackage: String
    /** Bech32m-encoded human readable version of the address. */
    public var transactionTracker: String
