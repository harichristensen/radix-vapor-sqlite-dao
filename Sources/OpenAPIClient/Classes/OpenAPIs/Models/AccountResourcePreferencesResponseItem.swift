...
public struct AccountResourcePreferencesResponseItem: Codable, JSONEncodable, Hashable {
    ...
    public init(resourceAddress: String, resourcePreferenceRule: AccountResourcePreferenceRule, lastUpdatedAtStateVersion: Int64) {
