...
public struct StateEntityDetailsResponseItem: Codable, JSONEncodable, Hashable {

    /** Bech32m-encoded human readable version of the address. */
    public var address: String
    public var fungibleResources: FungibleResourcesCollection?
    public var nonFungibleResources: NonFungibleResourcesCollection?
    public var ancestorIdentities: StateEntityDetailsResponseItemAncestorIdentities?
    public var metadata: EntityMetadataCollection
    public var explicitMetadata: EntityMetadataCollection?
    public var details: StateEntityDetailsResponseItemDetails?
